...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "C:/Users/jryan/AppData/Local/GitHubDesktop/app-2.8.3/resources/app/git/cmd/git.exe" rev-parse "${ref}^{commit}"
...
execute_process(
  COMMAND "C:/Users/jryan/AppData/Local/GitHubDesktop/app-2.8.3/resources/app/git/cmd/git.exe" show-ref "d5d052c806eee2ca1f858cb58b2f062d9fa25b90"
  WORKING_DIRECTORY "C:/dev/CuraEngine/cmake_build/stb-prefix/src/stb"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "d5d052c806eee2ca1f858cb58b2f062d9fa25b90")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("d5d052c806eee2ca1f858cb58b2f062d9fa25b90" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/d5d052c806eee2ca1f858cb58b2f062d9fa25b90")
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "C:/Users/jryan/AppData/Local/GitHubDesktop/app-2.8.3/resources/app/git/cmd/git.exe" fetch --tags --force "origin"
    WORKING_DIRECTORY "C:/dev/CuraEngine/cmake_build/stb-prefix/src/stb"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "C:/Users/jryan/AppData/Local/GitHubDesktop/app-2.8.3/resources/app/git/cmd/git.exe" symbolic-ref -q HEAD
    WORKING_DIRECTORY "C:/dev/CuraEngine/cmake_build/stb-prefix/src/stb"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "C:/Users/jryan/AppData/Local/GitHubDesktop/app-2.8.3/resources/app/git/cmd/git.exe" for-each-ref "--format='%(upstream:short)'" "${current_branch}"
      WORKING_DIRECTORY "C:/dev/CuraEngine/cmake_build/stb-prefix/src/stb"
...
execute_process(
  COMMAND "C:/Users/jryan/AppData/Local/GitHubDesktop/app-2.8.3/resources/app/git/cmd/git.exe" status --porcelain
  WORKING_DIRECTORY "C:/dev/CuraEngine/cmake_build/stb-prefix/src/stb"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "C:/Users/jryan/AppData/Local/GitHubDesktop/app-2.8.3/resources/app/git/cmd/git.exe" stash save --quiet;--include-untracked
    WORKING_DIRECTORY "C:/dev/CuraEngine/cmake_build/stb-prefix/src/stb"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "C:/Users/jryan/AppData/Local/GitHubDesktop/app-2.8.3/resources/app/git/cmd/git.exe" checkout "${checkout_name}"
    WORKING_DIRECTORY "C:/dev/CuraEngine/cmake_build/stb-prefix/src/stb"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "C:/Users/jryan/AppData/Local/GitHubDesktop/app-2.8.3/resources/app/git/cmd/git.exe" rebase "${checkout_name}"
    WORKING_DIRECTORY "C:/dev/CuraEngine/cmake_build/stb-prefix/src/stb"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/Users/jryan/AppData/Local/GitHubDesktop/app-2.8.3/resources/app/git/cmd/git.exe" rebase --abort
      WORKING_DIRECTORY "C:/dev/CuraEngine/cmake_build/stb-prefix/src/stb"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "C:/Users/jryan/AppData/Local/GitHubDesktop/app-2.8.3/resources/app/git/cmd/git.exe" stash pop --index --quiet
          WORKING_DIRECTORY "C:/dev/CuraEngine/cmake_build/stb-prefix/src/stb"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/dev/CuraEngine/cmake_build/stb-prefix/src/stb'."
    ...
    execute_process(
      COMMAND "C:/Users/jryan/AppData/Local/GitHubDesktop/app-2.8.3/resources/app/git/cmd/git.exe" tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/Users/jryan/AppData/Local/GitHubDesktop/app-2.8.3/resources/app/git/cmd/git.exe" reset --hard --quiet
      WORKING_DIRECTORY "C:/dev/CuraEngine/cmake_build/stb-prefix/src/stb"
    )
    execute_process(
      COMMAND "C:/Users/jryan/AppData/Local/GitHubDesktop/app-2.8.3/resources/app/git/cmd/git.exe" stash pop --quiet
      WORKING_DIRECTORY "C:/dev/CuraEngine/cmake_build/stb-prefix/src/stb"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "C:/Users/jryan/AppData/Local/GitHubDesktop/app-2.8.3/resources/app/git/cmd/git.exe" reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "C:/dev/CuraEngine/cmake_build/stb-prefix/src/stb"
      )
      execute_process(
        COMMAND "C:/Users/jryan/AppData/Local/GitHubDesktop/app-2.8.3/resources/app/git/cmd/git.exe" stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/dev/CuraEngine/cmake_build/stb-prefix/src/stb'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
